...
namespace Big::UserInterface
{
	...
	void UIManager::DrawHeader()
	{
		...
		case HeaderType::Static:
			DrawSprite("shopui_title_arenawar", "shopui_title_arenawar", m_PosX, m_DrawBaseY + (m_HeaderHeight / 2.f), m_Width, m_HeaderHeight, m_HeaderBackgroundColor, 0.f);
			break;
		case HeaderType::Gradient:
			...
			break;
		case HeaderType::Weapon: 
			DrawSprite("shopui_title_gr_gunmod", "shopui_title_gr_gunmod", m_PosX, m_DrawBaseY + (m_HeaderHeight / 2.f), m_Width, m_HeaderHeight, m_HeaderBackgroundColor, 0.f);
			m_HeaderText = false;
			break;
		case HeaderType::Vehicle:
			DrawSprite("shopui_title_carmod2", "shopui_title_carmod2", m_PosX, m_DrawBaseY + (m_HeaderHeight / 2.f), m_Width, m_HeaderHeight, m_HeaderBackgroundColor, 0.f);
			m_HeaderText = false;
			break;
		}
